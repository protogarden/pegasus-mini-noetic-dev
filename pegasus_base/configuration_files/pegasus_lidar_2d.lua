...
POSE_GRAPH.optimization_problem.huber_scale = 1.4e1
...
--POSE_GRAPH.constraint_builder.ceres_scan_matcher.rotation_weight = 1000.
--POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher.angular_search_window = math.rad(2.)
